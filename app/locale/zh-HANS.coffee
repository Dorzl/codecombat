...
#    paren_new: "(new)"
    ...
    no_students_yet_view_class: "查看课程并添加学生."
...
#    not_required: "Not required"
    ...
    copy_class_code: "复制教室代码"
    class_code_blurb: "未加入的学生可以在自己的功能页面输入该教室代码，或者访问网址加入。" # {change}
    copy_class_url: "复制教室链接地址"
    class_join_url_blurb: "新学生可以在登录之后，访问该网址加入教室。" # {change}
...
#    starter_licenses: "starter licenses"
    ...
    how_to_apply_licenses_blurb_1: "当教师第一次将课程分配给学生时，我们将自动应用许可证。 使用教室中的批量分配下拉菜单为所选学生分配课程：:"
    ...
    teacher_getting_started: "教师入门指南"
    teacher_getting_started_desc: "第一次使用 CodeCombat ？下载此教师入门指南开始设置您的账号，创建第一个课堂并邀请学生参加第一门课程。"
